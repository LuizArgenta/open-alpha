...
export const ptBR = {
  ...
  'quiz.explainDifferently': 'Ver este conceito explicado de outro jeito',
  ...
  'timeline.intervention.started': 'Ofereceu {what} em {concept}',
  'timeline.intervention.expected': 'esperava sair de {baseline}% para {target}%',
  'timeline.intervention.type.practice': 'mais prática',
  'timeline.intervention.type.micro_lesson': 'um passo menor',
  'timeline.intervention.type.explanation': 'outra explicação',
  'timeline.intervention.type.retrieval': 'um exercício de retomada',
  'timeline.intervention.type.diagnostic_probe': 'uma sondagem diagnóstica',
  'timeline.intervention.type.ai_tutoring': 'tutoria por IA',
  'timeline.intervention.type.worked_example': 'um exemplo resolvido',
  'timeline.intervention.type.teacher_action': 'tempo com uma professora',
  'timeline.intervention.type.external_resource': 'material de fora',
  'timeline.intervention.type.peer_activity': 'trabalho com um colega',
  'timeline.intervention.outcome.met': 'Funcionou — {concept} chegou a {observed}%',
  'timeline.intervention.outcome.not_met': 'Não chegou lá — {concept} em {observed}%',
  'timeline.intervention.outcome.inconclusive': 'Sem veredito em {concept}: a tentativa seguinte foi apressada, o que não diz nada nem a favor nem contra',
  'timeline.intervention.outcome.abandoned': 'Nunca retomou {concept}, então não se aprendeu nada sobre se ajudou',
